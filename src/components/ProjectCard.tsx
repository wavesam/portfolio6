...
const ProjectCard = ({
  ...
  return (
    <div className="flex flex-col gap-5 justify-between p-5 rounded-3xl bg-gradient-to-b from-white to-neutral-100 shadow-md shadow-neutral-400 hover:shadow-lg lg:rotate-1 hover:rotate-0 transition duration-300">
      {image && (
        <img
          src={image}
